...
// Validate checks the field values on LocalPresence with the rules defined in
// the proto definition for this message. If any rules are violated, the first
// error encountered is returned, or nil if there are no violations.
func (m *LocalPresence) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on LocalPresence with the rules defined
// in the proto definition for this message. If any rules are violated, the
// result is a list of violation errors wrapped in LocalPresenceMultiError, or
// nil if none found.
func (m *LocalPresence) ValidateAll() error {
	return m.validate(true)
}

func (m *LocalPresence) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if all {
		...
		case interface{ ValidateAll() error }:
			if err := v.ValidateAll(); err != nil {
				errors = append(errors, LocalPresenceValidationError{
					field:  "Presence",
					reason: "embedded message failed validation",
					cause:  err,
				})
		...
		if err := v.Validate(); err != nil {
			return LocalPresenceValidationError{
				field:  "Presence",
				reason: "embedded message failed validation",
				cause:  err,
			}
	...
	if all {
		switch v := interface{}(m.GetSynchronizedAt()).(type) {
		case interface{ ValidateAll() error }:
			if err := v.ValidateAll(); err != nil {
				errors = append(errors, LocalPresenceValidationError{
	...
	} else if v, ok := interface{}(m.GetSynchronizedAt()).(interface{ Validate() error }); ok {
		if err := v.Validate(); err != nil {
			return LocalPresenceValidationError{
				field:  "SynchronizedAt",
				reason: "embedded message failed validation",
	...
	if len(errors) > 0 {
		return LocalPresenceMultiError(errors)
	}

	return nil
}

// LocalPresenceMultiError is an error wrapping multiple validation errors
// returned by LocalPresence.ValidateAll() if the designated constraints
// aren't met.
type LocalPresenceMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m LocalPresenceMultiError) Error() string {
	msgs := make([]string, 0, len(m))
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m LocalPresenceMultiError) AllErrors() []error { return m }

// LocalPresenceValidationError is the validation error returned by
// LocalPresence.Validate if the designated constraints aren't met.
type LocalPresenceValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e LocalPresenceValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e LocalPresenceValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e LocalPresenceValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e LocalPresenceValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e LocalPresenceValidationError) ErrorName() string { return "LocalPresenceValidationError" }

// Error satisfies the builtin error interface
func (e LocalPresenceValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
...
var _ error = LocalPresenceValidationError{}
