...
import { OnyxTag, OnyxListItem, OnyxIcon, OnyxBasicPopover } from 'sit-onyx'
...
const filteredOptions = computed(() =>
  props.options.filter((t) => t.startsWith(inputValue.value) && !model.value?.includes(t)),
)
...
<template>
  <div class="form-elem">
    ...
    <div class="tag-list" v-else>
      <OnyxTag v-for="tag in model" :label="tag" :key="tag" density="compact" />
    </div>
  </div>
</template>
