...
import type { AuthServiceLoginData, AuthServiceLoginResponse, AuthServiceLoginError, AuthServiceLogoutData, AuthServiceLogoutResponse, AuthServiceLogoutError, AuthServiceRefreshData, AuthServiceRefreshResponse, AuthServiceRefreshError, BriefingServiceListBriefingTypesData, BriefingServiceListBriefingTypesResponse, BriefingServiceListBriefingTypesError, BriefingServiceCreateBriefingTypeData, BriefingServiceCreateBriefingTypeResponse, BriefingServiceCreateBriefingTypeError, BriefingServiceUpdateBriefingTypeData, BriefingServiceUpdateBriefingTypeResponse, BriefingServiceUpdateBriefingTypeError, BriefingServiceDeleteBriefingTypeData, BriefingServiceDeleteBriefingTypeError, BriefingServiceGetBriefingTypeData, BriefingServiceGetBriefingTypeResponse, BriefingServiceGetBriefingTypeError, BriefingServiceListBriefingsData, BriefingServiceListBriefingsResponse, BriefingServiceListBriefingsError, BriefingServiceCreateBriefingData, BriefingServiceCreateBriefingResponse, BriefingServiceCreateBriefingError, BriefingServiceUpdateBriefingData, BriefingServiceUpdateBriefingResponse, BriefingServiceUpdateBriefingError, BriefingServiceDeleteBriefingData, BriefingServiceDeleteBriefingError, BriefingServiceGetBriefingData, BriefingServiceGetBriefingResponse, BriefingServiceGetBriefingError, CardServiceListCardsData, CardServiceListCardsResponse, CardServiceListCardsError, CardServiceCreateCardData, CardServiceCreateCardResponse, CardServiceCreateCardError, CardServiceUpdateCardData, CardServiceUpdateCardResponse, CardServiceUpdateCardError, CardServiceDeleteCardData, CardServiceDeleteCardError, CardServiceGetCardData, CardServiceGetCardResponse, CardServiceGetCardError, MemberServiceListMemberAttributesData, MemberServiceListMemberAttributesResponse, MemberServiceListMemberAttributesError, MemberServiceCreateMemberAttributeData, MemberServiceCreateMemberAttributeResponse, MemberServiceCreateMemberAttributeError, MemberServiceUpdateMemberAttributeData, MemberServiceUpdateMemberAttributeResponse, MemberServiceUpdateMemberAttributeError, MemberServiceDeleteMemberAttributeData, MemberServiceDeleteMemberAttributeError, MemberServiceGetMemberAttributeData, MemberServiceGetMemberAttributeResponse, MemberServiceGetMemberAttributeError, MemberServiceListMemberTagsData, MemberServiceListMemberTagsResponse, MemberServiceListMemberTagsError, MemberServiceListMembersData, MemberServiceListMembersResponse, MemberServiceListMembersError, MemberServiceCreateMemberData, MemberServiceCreateMemberResponse, MemberServiceCreateMemberError, MemberServiceDeleteMemberData, MemberServiceDeleteMemberError, MemberServiceGetMemberData, MemberServiceGetMemberResponse, MemberServiceGetMemberError, MemberServiceUpdateMemberData, MemberServiceUpdateMemberResponse, MemberServiceUpdateMemberError, PresenceServiceListPresencesData, PresenceServiceListPresencesResponse, PresenceServiceListPresencesError, PresenceServiceCreatePresenceData, PresenceServiceCreatePresenceResponse, PresenceServiceCreatePresenceError, PresenceServiceDeletePresenceData, PresenceServiceDeletePresenceError, PresenceServiceUpdatePresenceData, PresenceServiceUpdatePresenceResponse, PresenceServiceUpdatePresenceError, PresenceServiceCheckinData, PresenceServiceCheckinResponse, PresenceServiceCheckinError, PresenceServiceCheckoutData, PresenceServiceCheckoutResponse, PresenceServiceCheckoutError } from './types.gen';
 ...
 */
export const authServiceLogin = <ThrowOnError extends boolean = false>(options: Options<AuthServiceLoginData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<AuthServiceLoginResponse, AuthServiceLoginError, ThrowOnError>({
        url: '/v1/auth/login',
        ...options,
        headers: {
 ...
 */
export const authServiceLogout = <ThrowOnError extends boolean = false>(options: Options<AuthServiceLogoutData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<AuthServiceLogoutResponse, AuthServiceLogoutError, ThrowOnError>({
        url: '/v1/auth/logout',
        ...options,
        headers: {
            'Content-Type': 'application/json',
 ...
 */
export const authServiceRefresh = <ThrowOnError extends boolean = false>(options: Options<AuthServiceRefreshData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<AuthServiceRefreshResponse, AuthServiceRefreshError, ThrowOnError>({
        url: '/v1/auth/refresh',
        ...options,
        headers: {
            'Content-Type': 'application/json',
...
export const memberServiceListMemberAttributes = <ThrowOnError extends boolean = false>(options?: Options<MemberServiceListMemberAttributesData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<MemberServiceListMemberAttributesResponse, MemberServiceListMemberAttributesError, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const memberServiceCreateMemberAttribute = <ThrowOnError extends boolean = false>(options: Options<MemberServiceCreateMemberAttributeData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<MemberServiceCreateMemberAttributeResponse, MemberServiceCreateMemberAttributeError, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const memberServiceUpdateMemberAttribute = <ThrowOnError extends boolean = false>(options: Options<MemberServiceUpdateMemberAttributeData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).patch<MemberServiceUpdateMemberAttributeResponse, MemberServiceUpdateMemberAttributeError, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const memberServiceDeleteMemberAttribute = <ThrowOnError extends boolean = false>(options: Options<MemberServiceDeleteMemberAttributeData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).delete<unknown, MemberServiceDeleteMemberAttributeError, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const memberServiceGetMemberAttribute = <ThrowOnError extends boolean = false>(options: Options<MemberServiceGetMemberAttributeData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<MemberServiceGetMemberAttributeResponse, MemberServiceGetMemberAttributeError, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
 ...
 */
export const memberServiceListMemberTags = <ThrowOnError extends boolean = false>(options?: Options<MemberServiceListMemberTagsData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<MemberServiceListMemberTagsResponse, MemberServiceListMemberTagsError, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
 ...
 */
export const presenceServiceCreatePresence = <ThrowOnError extends boolean = false>(options: Options<PresenceServiceCreatePresenceData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PresenceServiceCreatePresenceResponse, PresenceServiceCreatePresenceError, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
