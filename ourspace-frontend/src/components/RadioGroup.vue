...
.v-enter-active .tag,
.v-leave-active .tag,
.v-enter-active :deep(.onyx-radio-group__content),
.v-leave-active :deep(.onyx-radio-group__content) {
  transition:
    opacity 0.25s ease,
    height 0.25s ease;
  position: absolute;
...
.v-enter-from .tag,
.v-leave-to .tag,
.v-enter-from :deep(.onyx-radio-group__content),
.v-leave-to :deep(.onyx-radio-group__content) {
  opacity: 0;
  height: 24px;
}

.v-enter-active :deep(.onyx-radio-group__label),
.v-leave-active :deep(.onyx-radio-group__label) {
  display: none;
}
